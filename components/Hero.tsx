    ...
    <section className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="max-w-6xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex gap-4">
            <a
              ...
              className="p-3 bg-white/5 hover:bg-white/10 rounded-full border border-white/10 hover:border-purple-500 transition"
            >
              <Mail size={20} />
            </a>
          </div>
        ...
        <div className="flex-shrink-0">
          <div className="w-64 h-64 md:w-80 md:h-80 rounded-full border-4 border-purple-500/50 overflow-hidden bg-purple-900/20 flex items-center justify-center">
